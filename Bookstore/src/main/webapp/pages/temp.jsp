                    ...
                    <form  action="/BookStore/SignIn" method="post" autocomplete="on"> 
                        ...
                        <form  role="form" action="/BookStore/SignUp" method="post" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input  required="required" type="text" name="name" placeholder="Username" id="signup-username"/>
                                </p>
                                <p> 
...
<option value="ZW">Zimbabwe</option>
                            ...
                            <label  for="emailsignup" class="youmail" >Favorite Category</label>
                                ...
                                <select name="favourite"  class="youmail"  id="form-category">
                                ...
                                <input type="number" name="creditcard" placeholder="Creadet Cared limits "  id="form-gender"> 
                                </p>
